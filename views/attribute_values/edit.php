...
<div class="d-flex">
    ...
    <main class="wms-main p-4 flex-grow-1">
        ...
        <?php renderFlash(); ?>
        <form action="attribute_values.php?action=update" method="POST">
            <?= csrfField() ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="attribute_id" class="form-select" required>
                                ...
                                <?php foreach ($attributes as $attr): ?>
                                    <option value="<?= $attr['id'] ?>" <?= $item['attribute_id'] == $attr['id'] ? 'selected' : '' ?>><?= e($attr['attribute_name']) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Value <span class="text-danger">*</span></label>
                            <input type="text" name="value" class="form-control" value="<?= e($item['value']) ?>" required>
                        </div>
                        <div class="col-md-2">
            ...
            <div class="text-end">
                ...
                <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-circle"></i> Update Value</button>
            </div>
        </form>
    </main>
</div>
