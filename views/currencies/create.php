...
<div class="d-flex">
    ...
    <main class="wms-main p-4 flex-grow-1">
        ...
        <?php renderFlash(); ?>
        <form action="currencies.php?action=store" method="POST">
            <?= csrfField() ?>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-2">
                            ...
                            <input type="text" name="currency_code" class="form-control text-uppercase" required maxlength="10" placeholder="e.g. USD">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Currency Name <span class="text-danger">*</span></label>
                            <input type="text" name="currency_name" class="form-control" required placeholder="e.g. US Dollar">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Symbol <span class="text-danger">*</span></label>
                            <input type="text" name="currency_symbol" class="form-control" required maxlength="10" placeholder="e.g. $">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Exchange Rate</label>
                            <input type="number" step="0.000001" name="exchange_rate" class="form-control" value="1.000000" min="0">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-12">
                            <div class="form-check">
                                ...
                                <div class="form-text">Setting this as default will unset the previous default currency.</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-end">
                ...
                <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-circle"></i> Save Currency</button>
            </div>
        </form>
    </main>
</div>
