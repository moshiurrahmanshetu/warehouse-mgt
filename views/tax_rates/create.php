...
<div class="d-flex">
    ...
    <main class="wms-main p-4 flex-grow-1">
        <nav aria-label="breadcrumb"><ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Add Tax Rate</li>
        </ol></nav>
        ...
        <?php renderFlash(); ?>
        <form action="tax_rates.php?action=store" method="POST">
            <?= csrfField() ?>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="tax_name" class="form-control" required placeholder="e.g. Standard VAT, GST 15%">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Percentage (%) <span class="text-danger">*</span></label>
                            <input type="number" step="0.0001" name="tax_percentage" class="form-control" value="0.0000" min="0" max="100" required>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="text-end">
                ...
                <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-circle"></i> Save Tax Rate</button>
            </div>
        </form>
    </main>
</div>
