...
<div class="d-flex">
    ...
    <main class="wms-main p-4 flex-grow-1">
        ...
        <?php renderFlash(); ?>
        <form action="attributes.php?action=store" method="POST">
            <?= csrfField() ?>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="attribute_name" class="form-control" required placeholder="e.g. Color, Size, Material">
                        </div>
                        <div class="col-md-2">
            ...
            <div class="text-end">
                ...
                <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-circle"></i> Save Attribute</button>
            </div>
        </form>
    </main>
</div>
